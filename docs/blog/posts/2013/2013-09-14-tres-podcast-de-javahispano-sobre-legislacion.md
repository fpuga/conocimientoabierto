...
- <span style="line-height: 16px;">[Propiedad intelectual del software](http://www.javahispano.org/podcast/2008/11/23/javahispano-podcast-024-propiedad-intelectual-del-software-e.html). Que responde a preguntas como _¿Qué derechos tiene un programador asalariado sobre el software que escribe?_ con respuestas como _basicamente ninguna a no ser que pacte previamente_.</span>
