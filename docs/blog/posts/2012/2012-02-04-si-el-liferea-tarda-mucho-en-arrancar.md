...
[Liferea](http://liferea.sourceforge.net/) es un lector de feeds (como google reader, pero en aplicación de escritorio) libre que cumple su cometido. La verdad es que no me parece la _aplicación definitiva_ para leer rss pero funciona.
