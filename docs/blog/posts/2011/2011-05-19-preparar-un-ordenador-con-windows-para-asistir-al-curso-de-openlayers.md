...
[Descárgate este fichero](http://modwsgi.googlecode.com/files/mod_wsgi-win32-ap22py27-3.3.so) \[4\] y cópialo dentro de la carpeta c:xamppapachemodules. Cámbiale el nombre de mod_wsgi-win32-ap22py27-3.3.so a mod_wsgi.so
...
- \[4\] [http://modwsgi.googlecode.com/files/mod_wsgi-win32-ap22py27-3.3.so](http://modwsgi.googlecode.com/files/mod_wsgi-win32-ap22py27-3.3.so)
