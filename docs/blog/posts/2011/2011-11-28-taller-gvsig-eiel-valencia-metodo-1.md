...
Desde la interfaz de pgAdmin3 [se crea una nueva base de datos](http://www.youtube.com/watch?v=1wvDVBjNDys) usando como template «_template_postgis_» y luego se emplea el set de datos que proporcionamos sobre la base de datos que acabamos de crear. En caso de que hayamos llamado _gvsig-eiel_ a la base de datos hariamos:  
