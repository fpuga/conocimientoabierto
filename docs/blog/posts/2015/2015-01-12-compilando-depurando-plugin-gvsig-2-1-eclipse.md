...
Una vez que tenemos los «previos» realizados, creamos un nuevo workspace en eclipse, por ejemplo _workspace-gvsig-landregistry_.
...
Abrimos la perspectiva de eclipse de _SVN Repository Exploring_, desde _Window -&gt; Open perspective -&gt; Other_, o cualquier otro de los sitios desde los que se puede abrir.

Y añadimos el repositorio del plugin desde _File -&gt; New -&gt; Repository Location_ o el icono correspondiente. Como URL usaremos:  
...
configuramos el debugger. En _Debug Configurations_, añadiremos una nueva configuración del tipo _Remote Java Application_
