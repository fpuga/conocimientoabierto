...
Para montar las imágenes en el vídeo debemos investigar sus tamaños y sobre todo la relación de aspecto. El comando [identify](https://imagemagick.org/script/identify.php) de ImageMagick nos puede dar la información más relevante y podemos ordenarla por _aspect ratio_, anchura, …
...
Los parámetros más relevantes para el _slideshow_:
