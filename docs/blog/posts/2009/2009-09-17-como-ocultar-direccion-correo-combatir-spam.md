...
Existe una técnica más sencilla que la de usar imágenes consistente simplemente en _ofuscar_ tu dirección de correo **usando texto en lugar de símbolos** de modo que no sea reconocida por los bots. Por ejemplo en lugar de mail_falso@hosting_falso.no usa:
