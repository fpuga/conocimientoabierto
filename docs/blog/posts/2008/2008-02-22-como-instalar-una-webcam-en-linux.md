...
3. Instalar las fuentes del kernel que tengas instalado. Para ello debes buscar desde el gestor de software de tu distribución el paquete <span style="font-style: italic">kernel-source-tu_numero_de_kernel.</span> En mandriva en ocasiones llegará con ejecutar el comando <span style="font-style: italic">urpmi kernel-source-&amp;(uname -r)</span>
